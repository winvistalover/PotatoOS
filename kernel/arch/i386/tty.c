    ...
    if (data == '\b') {
        ...
        if (data == '\n') { // Null-terminate the input
            ...
            //    }
				...
				terminal_newline();
				terminal_newline();
				printf("help - View all available commands within PotatoOS.");
				terminal_newline();
                printf("ppm - PotatoOS Package Manager");
                terminal_newline();
				printf("clear - Clear all terminal output.");
				terminal_newline();
                printf("panic - Invoke a kernel panic.");
                terminal_newline();
				printf("reboot - Restart PotatoOS.");
				terminal_newline();
                printf("g - List all the contents of the currently open directory.");
                terminal_newline();
				printf("fatinit - Initialize a new FAT filesystem.");
                terminal_newline();
                printf("shutdown - Shut down PotatoOS.");
				terminal_newline();
				printf("color - Show the color test screen.");
				terminal_newline();
                printf("ls - List all the contents of the currently open directory.");
                terminal_newline();
				printf("echo - Output text into the terminal.");
				terminal_newline();
                printf("cat - Manage a file.");
                terminal_newline();
				printf("waitwrite - Wait a duration of time before outputting text into the terminal.");
                terminal_newline();
                printf("ld - Link object files and libraries into an executable.");
